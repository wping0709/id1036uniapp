  ...
  methods: {
    ...
    async receiveCoupon(item) {
      if (this.type == 'goods') {
        ...
        this.show = false;
		console.log(item,'888888888888888888888888')
        console.log( this.currenCoupon, 1111111111, this.isCreate);
        if (
          !this.isCreate &&
      ...
      if (this.type == 'goods') {
        ...
        this.selectCoupon =
          (this.goodsData.coupon_list && this.goodsData.coupon_list[0]) || '';
		   ...
		   console.log('我的select')
        this.receiveCoupon(this.goodsData[0]);
        this.couponList = this.goodsData;
      }
    },
  },
  computed: {
