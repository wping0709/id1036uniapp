  ...
  <view v-if="pageData && !store.is_shenhe" class="body">
    ...
    <view class="bg-fff m-b-20 round">
      <template v-for="(item, index) in payList">
        ...
        >
          ...
          <view>
            <text v-if="selectPay == index" class="iconfont icon-success price-color"></text>
          </view>
        </view>
      </template>
    </view>
    ...
    <view v-if="payList[selectPay]" class="bg-fff m-b-20">
      <view v-if="payList[selectPay].key == 'wechat'">
        <u-form ref="uForm" :model="form" :rules="rules" labelWidth="initial" errorType="toast">
          <view class="form-item-box">
            <u-form-item prop="name" required label="姓名">
              <u-input v-model="form.name" border="none" placeholder="请输入正确的微信姓名"></u-input>
            </u-form-item>
          </view>
          <view class="form-item-box">
            <u-form-item prop="mobile" required label="账号">
              <u-input v-model="form.mobile" border="none" placeholder="请输入正确的微信账号"></u-input>
            </u-form-item>
          </view>
        </u-form>
      </view>
      ...
      <view v-else-if="payList[selectPay].key == 'alipay'">
        <u-form ref="uForm" :model="form" :rules="rules" labelWidth="initial" errorType="toast">
          <view class="form-item-box">
            <u-form-item prop="name" required label="姓名">
              <u-input v-model="form.name" border="none" placeholder="请输入正确的支付宝姓名"></u-input>
            </u-form-item>
          </view>
          <view class="form-item-box">
            <u-form-item prop="mobile" required label="账号">
              <u-input v-model="form.mobile" border="none" placeholder="请输入正确的支付宝账号"></u-input>
            </u-form-item>
          </view>
        </u-form>
      </view>
        ...
        <u-form ref="uForm" :model="form" :rules="rules" labelWidth="initial" errorType="toast">
          <view class="form-item-box">
            <u-form-item prop="name" required label="开户人">
              <u-input v-model="form.name" border="none" placeholder="请输入正确的姓名"></u-input>
            </u-form-item>
          </view>
          <view class="form-item-box">
            <u-form-item prop="bank_name" required label="开户行">
              <u-input v-model="form.bank_name" border="none" placeholder="请输入正确的银行名称"></u-input>
            </u-form-item>
          </view>
          <view class="form-item-box">
            <u-form-item prop="mobile" required label="开户账号">
              <u-input v-model="form.mobile" border="none" placeholder="请输入正确的银行卡账号"></u-input>
            </u-form-item>
          </view>
        </u-form>
      </view>
    ...
    <view v-if="pageData.cash_max_day" class="msg-box">
      ...
      <view v-if="(!pageType || pageType == 'shop') && pageData.service_content">
    ...
    <u-popup :show="orderShow" round="30rpx" @close="orderShow = false">
      <div class="popup-box">
        ...
        <scroll-view scroll-y style="height: 40vh" class="order-list">
          <div class="order-item flex-y-center" @click="switchOrder(order, i)" v-for="(order, i) in pageData.share_log"
            :key="i">
            <div class="flex-y-center">
              <text v-if="order.check" class="iconfont icon-success-fill price-color font-40"></text>
