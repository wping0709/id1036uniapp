<template>
  <view class="u-waterfall">
    <view id="u-left-column" class="u-column m-r-10"
      ><slot name="left" :leftList="leftList" :showDel="showDel"></slot
    ></view>
    <view id="u-right-column" class="u-column"
      ><slot name="right" :rightList="rightList" :showDel="showDel"></slot
    ></view>
  </view>
</template>
