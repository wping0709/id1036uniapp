<template>
  <view class="page-body flex-col">
    ...
    <scroll-view @scrolltolower="getList()" scroll-y class="flex-h-1">
      ...
      <div v-else>
        <List ref="List" :list.sync="pageData.list"></List>
...
export default {
  ...
  methods: {
    inputFocus() {
      console.log(uni.getStorageSync("shakeHistory"), 123);
      this.historyList = uni.getStorageSync("shakeHistory") || [];
      this.is_focus = true;
    },
    inputBlur() {
      // this.is_focus = false
    ...
    async deleteHistory() {
      ...
      if (!confirm) return;
      uni.removeStorageSync("shakeHistory");
      this.historyList = [];
    },
    listData() {
      return uni.getStorageSync("shakeHistory") || [];
    },
    async inputConfirm(e) {
      console.log(e);
      let list = uni.getStorageSync("shakeHistory") || [];
      ...
      uni.setStorageSync("shakeHistory", list);
      this.is_focus = false;
      this.getList(true);
    },
