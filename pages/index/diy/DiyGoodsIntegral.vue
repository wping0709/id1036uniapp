<template>
  <view v-if="pageData" class="body">
    ...
    <view class="top-model" v-if="pageData.param.cat_position == 0">
      <!-- 商品区域 -->
      <view v-if="pageData.param.is_goods == 1" class="goods-box bg-fff">
        <!-- 商品展示方式为一行一个 -->
              ...
              <view>
                ...
                <view class="flex-x-sb flex-y-center font-28 price-bt">
                  <view
                    ...
                    class="color-999 font-26 flex-w-1"
                    >{{ goods.original_price_content }}</view
                  >
          ...
          >
            <view class="goods-left">
              ...
              <image
                ...
                mode="aspectFit"
                class=""
                style="width: 702rpx; height: 468rpx"
              />
              <!-- 当前图为1:1 -->
              <image
                v-else
                ...
                mode="aspectFit"
                class=""
                style="width: 702rpx; height: 702rpx"
              />
...
export default {
  ...
  methods: {
    async loadData() {
      ...
      const res = await this.$requestAll.home.getTemplateData(formData, true);
